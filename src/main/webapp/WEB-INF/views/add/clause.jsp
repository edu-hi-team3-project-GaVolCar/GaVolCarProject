...
<body>
	...
	<h3 style="text-align: center; font-size: 40px; padding: 60px 0;">회원가입
		전 약관</h3>
	<div style="margin: 0 auto; width: 1200px; border: 2px solid black;">
		<img src="../투명로고.png" style="width: 300px;">
		<p style="text-align: center; font-size: 35px; padding: 30px;">다음의
			약관을 읽으신 후에 절차를 진행해 주시길 바랍니다.</p>
		<p style="text-align: center; color: red; padding: 30px;">※비동의시
			회원가입이 진행되지 않습니다.</p>
		<div style="margin: 0 auto; width: 700px;">
			<p>1.회사는 다음의 약관을 사용자에게 요구하게 된다.</p>
			<p>2.개인정보 수집</p>
			<p>3.광고성 메일 수신 동의</p>
			<p>4.개인 연락처 수집</p>
			<p>5.개인 계좌번호 수집</p>
			<p>6.개인정보 제3자 활용에 대한 동의</p>
			<p>7.개인정보의 활용에 대한 모든 권리를 포기</p>
		</div>
	</div>
	<div class="row" style="margin: 0 auto; width: 700px; font-size: 20px;">
		<input style="margin: 60px;" type="button"
			onclick="location.href='/addForm2'" value="동의한다"> <input
			style="margin: 60px;" type="button" onclick="location.href='/'"
			value="동의하지 않는다">
	</div>
