	...
	<div class="container col-12">
		<div class="row">
			...
			<div class="col-10" style="border-left: 5px solid gray;">
				...
				<table style="width: 1000px; height: 400px; margin: 30px auto;"
					...
					<form action="modify" method="get">
						...
						<tr>
							...
							<td class="cont"><input style="width: 90%; height: 90%;"
								type="password" name="user_pw" value="${info.user_pw}">
							</td>
						</tr>
						<tr>
							<td class="bar">이름</td>
							<td class="cont"><input style="width: 90%; height: 90%;"
								type="text" name="user_name" value="${info.user_name}"></td>
						</tr>
						<tr>
							<td class="bar">전화번호</td>
							<td class="cont"><input style="width: 90%; height: 90%;"
								type="text" name="user_phone_number"
								value="${info.user_phone_number}"></td>
						</tr>
						<tr>
							<td class="bar">나이</td>
							<td class="cont"><input style="width: 90%; height: 90%;"
								type="text" name="user_age" value="${info.user_age}"></td>
						</tr>
						<tr>
							<td class="bar">이메일</td>
							<td class="cont"><input style="width: 90%; height: 90%;"
								type="text" name="user_email" value="${info.user_email}"></td>
						</tr>
						<tr height="45px;">
							<td colspan="2"><input style="width: 60px; height: 40px;"
								type="submit" value="수정"> &nbsp;&nbsp;<a
								href="delete?user_id=${info.user_id}">삭제</a> &nbsp;&nbsp; <a
								href="list">목록보기</a>
						</tr>
						<!--&nbsp; : 공백주는 것  -->
					</form>
