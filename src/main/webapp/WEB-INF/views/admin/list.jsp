	...
	<div class="container col-12">
		<div class="row">
			...
			<div class="col-10" style="border-left: 5px solid gray;">
				<div id="pagetitle"
					style="text-align: center; height: 120px; line-height: 120px; font-size: 50px; font-weight: 700;">회원정보
					관리</div>

				<h2 style="margin: 60px auto; width: 1200px;">회원 목록</h2>
				<table id="table" width="1400px;"
					style="margin: 30px auto; text-align: center; border-spacing: 0px;">
					<tr style="height: 50px; font-size: 25px;">
						<td
							style="border-bottom: 4px solid black; border-top: 4px solid black;">아이디</td>
						<td
							style="border-bottom: 4px solid black; border-top: 4px solid black;">비밀번호</td>
						<td
							style="border-bottom: 4px solid black; border-top: 4px solid black;">이름</td>
						<td
							style="border-bottom: 4px solid black; border-top: 4px solid black;">전화번호</td>
						<td
							style="border-bottom: 4px solid black; border-top: 4px solid black;">나이</td>
						<td
							style="border-bottom: 4px solid black; border-top: 4px solid black;">이메일</td>
					</tr>
					...
					<c:forEach var="member" items="${MemberList}">
						<tr>
							...
							<td style="border-bottom: 2px solid gray; height: 50px;"><a
								href="info?user_id=${member.user_id}">${member.user_name}</td>
