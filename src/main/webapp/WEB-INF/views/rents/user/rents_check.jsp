...
<script type="text/javascript">
	function deletePopup() {
		window.open("../deletePopup", "delete",
				"width=500, height=300, left=100, top=50");
	}
	function modifyPopup() {
		window.open("../modifyPopup", "modify",
...
<body>
	...
	<div style="background-color: rgb(189, 189, 189); line-height: 25px;">
		...
		<div style="color: gray;">-예약기간내에 환불을 신청하지 못하셨을 경우 환불을 받으실 수
			없습니다.</div>
		<div style="color: gray;">-고객님의 단순변심으로 인해서 환불이 진행되야 할 시에는 환불을
			받으실 수 없습니다.</div>
		<div style="color: gray;">-천재지변에 의한 환불요구의 경우 환불을 받으실 수 없습니다.</div>
		<div style="color: gray;">-구속, 기소의 이유로 예약을 취소해야하는 경우 환불을 받으 실 수
			없습니다.</div>
		<div style="color: gray;">-상해 입원등의 이유로 예약을 취소해야하는 경우 환불을 받으 실 수
			없습니다.</div>
		<div style="color: gray;">-만일 고객님의 사망시에는 환불을 받으실 수 없습니다.</div>
		<div style="color: gray;">-배편이 끊겨 매장까지 오실 수 없으실 때는 환불을 받으실 수
			없습니다.</div>
		<div style="color: gray;">-회사의 문제로 인하여 환불을 받을 시에는 전액환불을 받으 실 수
			있습니다.</div>
		<div style="color: gray;">-단, 환불이 이루어지는 기간은 회사의 사정에 의해 임의로 조정될 수
			있습니다.</div>
	</div>
